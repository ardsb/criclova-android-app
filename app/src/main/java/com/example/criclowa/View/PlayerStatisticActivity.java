...
public class PlayerStatisticActivity extends AppCompatActivity {
    ...
    TextView txtMatchesBowling, txtInningsBowling, txtBalls, txtRunsBowling, txtWkts, txtBBI, txtBBM
            ,txtAveBowling, txtEcon, txtSRBowling, txt4w, txt5w, txt10Bowling; //For Bowlers List A

    TextView txtMatches,txtInnings,txtNO,txtRuns,txtHS,txtAve,txtBF,txtSR,txt4s,txt6s,txtCt,txtSt
            ,txt50,txt100; //For Batsmen List A

    TextView txtMatchesBowlingFirstClass, txtInningsBowlingFirstClass, txtBallsFirstClass
            ,txtRunsBowlingFirstClass, txtWktsFirstClass, txtBBIFirstClass, txtBBMFirstClass
            ,txtAveBowlingFirstClass, txtEconFirstClass, txtSRBowlingFirstClass, txt4wFirstClass
            ,txt5wFirstClass, txt10BowlingFirstClass; //For Bowlers First Class

    TextView txtMatchesFirstClass,txtInningsFirstClass,txtNOFirstClass,txtRunsFirstClass,txtHSFirstClass
            ,txtAveFirstClass,txtBFFirstClass,txtSRFirstClass,txt4sFirstClass,txt6sFirstClass
            ,txtCtFirstClass,txtStFirstClass,txt50FirstClass,txt100FirstClass; //For Batsmen FirstClass
